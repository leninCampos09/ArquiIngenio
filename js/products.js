// Sample product data
    const PRODUCTS = [
      {id:1,model:'09451-ME-05',title:'Nivel láser rotativo PRO 360',category:'herramientas',price:299.99,previousPrice:379.99,desc:'Nivel láser para obras con autonivel y base magnética.',img:'/img/laser1.webp'},
      {id:2,model:'10102-PL-01',title:'Pack de planos arquitectónicos (Vivienda)',category:'planos',price:49.00,previousPrice:59.00,desc:'Planos completos listos para adaptar a tu proyecto.',img:'/img/planes.avif'},
      {id:3,model:'22011-LC-10',title:'Licencia CAD Profesional (1 año)',category:'software',price:399.00,previousPrice:499.00,desc:'Licencia anual para diseño CAD con herramientas avanzadas.',img:'/img/li.webp'},
      {id:4,model:'04500-HM-01',title:'Juego de herramientas de mano 45 piezas',category:'herramientas',price:89.50,desc:'Juego completo para obra y mantenimiento.',img:'/img/her.jpg'},
      {id:5,model:'03025-CT-01',title:'Concreto premezclado 25kg (unidad)',category:'materiales',price:12.75,desc:'Saco de concreto de alta resistencia.',img:'/img/c.png'},
      {id:6,model:'14001-TB-02',title:'Tablet gráfica para dibujo técnico',category:'hardware',price:219.99,previousPrice:259.99,desc:'Ideal para modelado y edición de planos.',img:'/img/t.jpg'},

      // Muebles
      {id:7,model:'33010-SF-03',title:'Sofá modular 3 plazas',category:'muebles',price:499.00,desc:'Sofá modular con tapizado resistente y estructura metálica.',img:'/pr/sofa.jpg'},
      {id:8,model:'33011-TB-04',title:'Mesa de trabajo industrial',category:'muebles',price:179.99,desc:'Mesa de trabajo amplia con superficie reforzada para planos y herramientas.',img:'/img/me.png'},
      {id:9,model:'33012-ES-05',title:'Estantería metálica 5 niveles',category:'muebles',price:129.50,desc:'Estantería para almacén o taller con alta capacidad de carga.',img:'/pr/we.webp'},
      {id:10,model:'33013-SC-06',title:'Silla ergonómica de oficina',category:'muebles',price:149.00,desc:'Silla con soporte lumbar y ajuste de altura para largas jornadas.',img:'/pr/silla.jpg'},
      {id:11,model:'33014-MP-07',title:'Mueble para planos enrollables',category:'muebles',price:89.00,desc:'Mueble compacto para almacenar y organizar planos grandes.',img:'/pr/i.webp'},

      // Computación
      {id:12,model:'56001-LP-08',title:'Laptop Ultrabook 14"',category:'computacion',price:899.99,previousPrice:1099.99,desc:'Ultrabook ligero con procesador moderno y 8GB RAM.',img:'https://m.media-amazon.com/images/I/71ahPnMhKvL._AC_SL1500_.jpg',cpu:'Intel i5 / Ryzen 5',ram:'8 GB',storage:'256 GB SSD',screen:'14" FHD',weight:'1.3 kg',battery:'52.5 Wh (3 celdas)'},
      {id:13,model:'56002-PC-09',title:'PC de escritorio (i5, 16GB)',category:'computacion',price:699.00,desc:'Equipo de sobremesa para diseño y tareas intensivas.',img:'https://gw.alicdn.com/imgextra/i4/2757821387/O1CN014uGrZ91M7I7pxJhGO_!!2757821387.jpg_540x540.jpg'},
      {id:14,model:'56003-MN-10',title:'Monitor 27" 1440p',category:'computacion',price:279.00,desc:'Pantalla QHD con buen color y ángulos amplios para diseño.',img:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_tsipfHujIdk7M_ARvAtOqtWeH54DQK0NCw&s'},
      {id:15,model:'56004-TK-11',title:'Teclado mecánico retroiluminado',category:'computacion',price:79.99,desc:'Teclado con switches táctiles y retroiluminación RGB.',img:'https://www.megatone.net/images/Articulos/zoom2x/322/MKT0016EXO_14.jpg'},
      {id:16,model:'56005-MO-12',title:'Mouse inalámbrico ergonómico',category:'computacion',price:39.50,desc:'Mouse con botones programables y gran autonomía.',img:'/img/mo.webp'},

      // Memorias
      {id:17,model:'77001-SSD-13',title:'SSD SATA 1TB',category:'memorias',price:119.00,desc:'Unidad de estado sólido para arranque y almacenamiento rápido.',img:'/img/ssd.jpeg'},
      {id:18,model:'77002-NV-14',title:'SSD NVMe 500GB',category:'memorias',price:79.99,desc:'Disco NVMe compacto con altas tasas de lectura/escritura.',img:'/img/pf.jpeg'},
      {id:19,model:'77003-RAM-15',title:'RAM 16GB DDR4',category:'memorias',price:64.99,desc:'Módulo de memoria para mejorar multitarea y rendimiento CAD.',img:'/img/mem.jpg'},
      {id:20,model:'77004-RM-16',title:'RAM 8GB DDR4',category:'memorias',price:34.50,desc:'Módulo de memoria compatible con la mayoría de laptops y PCs.',img:'/img/meb.jpg'},
      {id:21,model:'77005-PD-17',title:'Pendrive 128GB USB 3.0',category:'memorias',price:19.99,desc:'Memoria portátil para transporte de archivos y planos.',img:'/img/pen.jpg'},

      // UPS
      {id:22,model:'88001-U1-18',title:'UPS 1000VA',category:'ups',price:129.99,previousPrice:159.99,desc:'Protección de energía para equipos pequeños y estaciones de trabajo.',img:'/img/va.webp'},
      {id:23,model:'88002-U1-19',title:'UPS 1500VA',category:'ups',price:199.99,desc:'Mayor autonomía y protección para servidores y PCs de alto consumo.',img:'/img/ups1.webp'},
      {id:24,model:'88003-U3-20',title:'UPS 3000VA industrial',category:'ups',price:499.00,desc:'UPS para instalaciones con demandas críticas de energía.',img:'/img/ups3.jpg'},
      {id:25,model:'88004-BT-21',title:'Batería de reemplazo 12V',category:'ups',price:49.50,desc:'Batería compatible con múltiples modelos de UPS.',img:'/img/ups4.avif'},
      {id:26,model:'88005-SP-22',title:'Supresor de picos y protector',category:'ups',price:24.99,desc:'Protector de sobrevoltajes para líneas eléctricas y equipos.',img:'/img/ups5.webp'},

      // Discos Duros
      {id:27,model:'99001-H1-23',title:'HDD 1TB 7200RPM',category:'discos',price:45.00,desc:'Disco duro mecánico para almacenamiento masivo.',img:'/img/disco1.webp'},
      {id:28,model:'99002-H2-24',title:'HDD 2TB 7200RPM',category:'discos',price:69.99,desc:'Disco de alta capacidad para backups y archivos grandes.',img:'/img/disco2.jpg'},
      {id:29,model:'99003-NV1-25',title:'SSD NVMe 1TB',category:'discos',price:129.99,desc:'Unidad NVMe para cargas rápidas de proyectos y software.',img:'/img/disco3.webp'},
      {id:30,model:'99004-EX2-26',title:'Disco externo 2TB USB 3.0',category:'discos',price:89.00,desc:'Caja externa para transportar y respaldar información.',img:'/img/disco4.webp'},
      {id:31,model:'99005-NAS4-27',title:'NAS 4 bahías',category:'discos',price:349.00,desc:'Servidor de archivos para oficina con RAID y acceso en red.',img:'/img/disco5.webp'},

      // Tintas
      {id:32,model:'00101-TN-28',title:'Cartucho tinta negro',category:'tintas',price:9.99,desc:'Cartucho de tinta negra original para impresoras de oficina.',img:'/img/tinta1.webp'},
      {id:33,model:'00102-TC-29',title:'Cartucho tinta color',category:'tintas',price:12.99,desc:'Cartucho color (CMY) para impresiones a todo color.',img:'/img/tinta2.jpg'},
      {id:34,model:'00103-TL-30',title:'Toner negro para láser',category:'tintas',price:39.99,desc:'Toner de alta capacidad para impresoras láser.',img:'/img/tinta3.jpg'},
      {id:35,model:'00104-TK-31',title:'Toner color',category:'tintas',price:69.99,desc:'Kit de toner color para impresoras láser a color.',img:'/img/tinta4.webp'},
      {id:36,model:'00105-KC-32',title:'Kit de limpieza de cabezales',category:'tintas',price:14.50,desc:'Solución y herramientas para mantener impresoras limpias.',img:'/img/tinta5.jpg'},

      // Iluminación
      {id:37,model:'11201-PL-33',title:'Panel LED 60x60 40W',category:'iluminacion',price:59.99,desc:'Panel empotrable para iluminación de oficinas y salas.',img:'/img/ilu1.webp'},
      {id:38,model:'11202-LD-34',title:'Lámpara de escritorio LED',category:'iluminacion',price:24.99,desc:'Lámpara con regulación de intensidad y brazo flexible.',img:'/img/ilu2.jpg'},
      {id:39,model:'11203-TB-35',title:'Tubo LED 120cm 18W',category:'iluminacion',price:12.50,desc:'Tubo LED para reemplazo de fluorescentes.',img:'/img/ilu3.jpg'},
      {id:40,model:'11204-RF-36',title:'Reflector LED 50W',category:'iluminacion',price:29.99,desc:'Reflector para iluminación exterior y obras.',img:'/img/ilu4.jpg'},
      {id:41,model:'11205-LI-37',title:'Luminaria industrial 200W',category:'iluminacion',price:129.00,desc:'Luminaria para naves industriales y grandes espacios.',img:'/img/ilu5.png'},

      // Hardware (herramientas eléctricas y elementos)
      {id:42,model:'12101-DR-38',title:'Taladro percutor 650W',category:'hardware',price:89.99,desc:'Taladro con modos rotación y percutor para obra y bricolaje.',img:'/img/hw1.png'},
      {id:43,model:'12102-BR-39',title:'Juego de brocas 50 piezas',category:'hardware',price:24.99,desc:'Set completo de brocas para metal, madera y hormigón.',img:'/img/hw2.webp'},
      {id:44,model:'12103-SR-40',title:'Tornillos surtidos (500pc)',category:'hardware',price:19.99,desc:'Caja con tornillos y anclajes para construcción y montaje.',img:'/img/hw3.jpg'},
      {id:45,model:'12104-JW-41',title:'Juego de llaves combinadas 12pc',category:'hardware',price:34.50,desc:'Llaves de mano para mantenimiento y montaje.',img:'/img/hw4.jpg'},
      {id:46,model:'12105-SC-42',title:'Sierra circular manual 1200W',category:'hardware',price:129.99,desc:'Sierra para cortes precisos en madera y paneles.',img:'/img/s.avif'}
    ];
    ...
    (function augmentProducts() {
      const warrantyCategories = ['computacion','memorias','discos','ups','hardware','muebles','iluminacion'];
      ...
      for(const p of PRODUCTS){
        ...
        p.model = p.model || p.title.split(' ').slice(0,3).join(' ').replace(/\"/g,'');
        ...
        if(typeof p.warranty === 'undefined'){
          if(p.category === 'planos') p.warranty = 'Sin garantía (producto digital)';
        ...
        if(typeof p.safety === 'undefined'){
          if(p.category === 'herramientas') p.safety = 'Usar protección ocular y guantes. Riesgo de lesiones si se utiliza incorrectamente.';
          else if(p.category === 'hardware') p.safety = 'Apagar y desconectar antes de abrir. Manipular con cuidado componentes eléctricos.';
          else if(p.category === 'ups') p.safety = 'Riesgo eléctrico y de batería. Instalar en área ventilada y seguir instrucciones del fabricante.';
          else if(p.category === 'iluminacion') p.safety = 'Evitar contacto con agua. Manipular con guantes si está caliente.';
          else p.safety = null;
        }
        ...
        if(typeof p.manufacturer === 'undefined'){
          ...
          const knownBrands = ['Bosch','Hilti','DeWalt','Makita','Autodesk','Revit','SketchUp','Sika'];
          let found = knownBrands.find(b => p.title.includes(b));
          p.manufacturer = found || makersByCategory[p.category] || 'Fabricante Genérico';
        }
        ...
        if(typeof p.stock === 'undefined') p.stock = 10;
          switch(p.category){
            case 'herramientas':
            case 'hardware':
              specs.push(`Potencia: ${p.power || (p.title.match(/\b(\d{2,4}W|\d{3,4}W)\b/)||[''])[0] || 'N/A'}`);
            ...
            case 'computacion':
              ...
              specs.push(`Almacenamiento: ${p.storage || (p.title.includes('SSD')? '1 TB SSD' : '256 GB')}`);
            ...
            case 'memorias':
            case 'discos':
              specs.push(`Capacidad: ${p.capacity || (p.title.match(/(\d+TB|\d+GB)/)||[''])[0] || 'N/A'}`);
              specs.push(`Interfaz: ${p.interface || 'SATA / NVMe'}`);
              break;
            case 'ups':
              specs.push(`Capacidad: ${p.capacityVA || (p.title.match(/(\d{3,4}VA)/)||[''])[0] || 'N/A'}`);
    ...
    function showFluentAlert(message, title = 'Aviso', type = 'info'){
      return new Promise((resolve)=>{
        try{
          // build backdrop
          const backdrop = document.createElement('div'); backdrop.className = 'fluent-alert-backdrop';
          backdrop.tabIndex = -1;

          const dlg = document.createElement('div'); dlg.className = 'fluent-alert';
          dlg.setAttribute('role','alertdialog'); dlg.setAttribute('aria-modal','true');

          const header = document.createElement('div'); header.className = 'header';
          const icon = document.createElement('div'); icon.className = 'icon';
          icon.style.width = '36px'; icon.style.height = '36px'; icon.style.borderRadius = '8px'; icon.style.display='flex'; icon.style.alignItems='center'; icon.style.justifyContent='center'; icon.style.color='white';
          if(type==='success') icon.style.background = 'linear-gradient(135deg,#0bbf59,#007a3d)';
          else if(type==='error') icon.style.background = 'linear-gradient(135deg,#e0403d,#b91c1c)';
          ...
          const msg = document.createElement('div'); msg.className = 'message'; msg.innerHTML = String(message).replace(/\n/g,'<br>');

          const actions = document.createElement('div'); actions.className = 'actions';
          const btnOk = document.createElement('button'); btnOk.className = 'btn primary'; btnOk.textContent = 'Aceptar';
          const btnCancel = document.createElement('button'); btnCancel.className = 'btn secondary'; btnCancel.textContent = 'Cerrar';

          actions.appendChild(btnCancel); actions.appendChild(btnOk);
          dlg.appendChild(header); dlg.appendChild(msg); dlg.appendChild(actions);
          ...
          function onBackdrop(e){ if(e.target===backdrop){ /* click outside closes dialog */ cleanup(); resolve(false); } }
        ...
        }catch(err){ console.error(err); try{ alert(message); }catch(_){} resolve(true); }
      });
    }
    ...
    function shareWhatsApp(id){
      ...
      const text = encodeURIComponent(`${p.title} - $${formatPrice(p.price)} ${url}`);
    ...
    async function copyProductLink(id){
      ...
      try{
        ...
        showFluentAlert('Enlace copiado al portapapeles:\n' + url, 'Enlace copiado', 'success');
      }catch(e){
        ...
        showFluentAlert('Enlace copiado al portapapeles (fallback)', 'Enlace copiado', 'success');
      }
    }
    ...
    function renderProducts(list=PRODUCTS){
      ...
      if(!list || list.length === 0){
        ...
        `;
        try{ document.getElementById('shownCount').textContent = 0; }catch(e){}
        return;
      }
      list.forEach(p=>{
        ...
        card.innerHTML = `
          ...
          <div style="text-align:right">
            ...
            <div style="margin-top:10px;display:flex;gap:8px">
              <button class="btn btn-primary" onclick="addToCart(${p.id})">Añadir</button>
              <button class="btn btn-ghost" onclick="previewProduct(${p.id})">Ver</button>
            </div>
          </div></div>
        `;
      ...
      list.forEach(p => {
        ...
        card.innerHTML = `
          ...
          <div class="featured-body">
            ...
            <h3 class="title">${p.title}</h3>
            <p class="muted desc" style="margin:6px 0 10px">${p.desc}</p>
            ${
              p.previousPrice
  ...
  <div style="display:flex;align-items:center;gap:6px">
    ...
    <div style="display:flex;flex-direction:column">
      ...
      container.querySelectorAll('.qty-btn').forEach(btn=>{
        btn.addEventListener('click', (e)=>{
          ...
          if(btn.textContent.trim()==='+') val++; else val = Math.max(1, val-1);
          span.textContent = val;
        });
      });

      // update shownCount if exists
      try{ document.getElementById('shownCount').textContent = list.length; }catch(e){}
    }
    ...
    function showSuccessMessage(productName){
      ...
      toast.style.cssText = 'background:#10b981;color:white;padding:14px 18px;border-radius:8px;margin-bottom:8px;display:flex;align-items:center;gap:10px;animation:slideIn 300ms ease;box-shadow:0 8px 24px rgba(16,185,129,0.25);font-size:14px;font-weight:500';
      toast.innerHTML = `
      ...
      setTimeout(() => {
        ...
        if(CART.length===0){
          ...
          CART.forEach((i, index) => {
            html += `
              <div style="display:flex;gap:12px;align-items:center;padding:12px;border-radius:8px;border:1px solid rgba(11,18,32,0.03);background:white;animation:fadeIn 300ms ease ${index * 50}ms both">
                <div style="width:60px;height:60px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#f0f0f0;display:flex;align-items:center;justify-content:center">
                  <img src="${i.img}" alt="${i.title}" style="width:100%;height:100%;object-fit:cover;animation:imageLoad 400ms ease">
                </div>
                <div style="flex:1">
                  <div style="display:flex;justify-content:space-between;align-items:start">
                    <div>
                      <strong>${i.title}</strong>
                      <div class='muted' style='font-size:13px'>$${formatPrice(i.price)} x ${i.qty}</div>
                    </div>
                    <div style='display:flex;gap:6px;align-items:center'>
                      <button class='btn btn-ghost' onclick='decreaseQty(${i.id})'>-</button>
                      <div>${i.qty}</div>
                      <button class='btn btn-ghost' onclick='increaseQty(${i.id})'>+</button>
                      <button class='btn btn-ghost' onclick='removeItem(${i.id})'>Eliminar</button>
                    </div>
                  </div>
                </div>
              </div>`;
    ...
    function toggleLoginDropdown(e){
      ...
      if(isOpen){ dropdown.style.display = 'none'; dropdown.setAttribute('aria-hidden','true'); btn.setAttribute('aria-expanded','false'); }
      else { dropdown.style.display = 'block'; dropdown.setAttribute('aria-hidden','false'); btn.setAttribute('aria-expanded','true'); }
    ...
    document.addEventListener('click', function(ev){
      ...
      if(ev.target.closest && !ev.target.closest('.user-dropdown')){
        dropdown.style.display = 'none'; dropdown.setAttribute('aria-hidden','true'); btn.setAttribute('aria-expanded','false');
      }
    });
    ...
    async function submitRegister(){
      ...
      if(!name || !email || !pass){ await showFluentAlert('Completa todos los campos', 'Error', 'error'); return; }
      if(pass !== pass2){ await showFluentAlert('Las contraseñas no coinciden', 'Error', 'error'); return; }
      // Placeholder: aquí se enviaría al backend. Simulamos éxito.
      closeModal();
      await showFluentAlert('Cuenta creada correctamente. Ya puedes iniciar sesión.', 'Éxito', 'success');
    }
    ...
    async function submitLogin(){
      ...
      if(!email || !pass){ await showFluentAlert('Ingresa correo y contraseña', 'Error', 'error'); return; }
      try{
        ...
        if(res && res.ok){
          closeModal();
          await showFluentAlert('Sesión iniciada: ' + (res.user && res.user.email ? res.user.email : ''), 'Éxito', 'success');
          if(window.__afterAuthCallback && typeof window.__afterAuthCallback === 'function'){
            const cb = window.__afterAuthCallback; window.__afterAuthCallback = null; cb();
          }
        } else {
          await showFluentAlert((res && res.msg) ? res.msg : 'Error de autenticación', 'Error', 'error');
        }
      }catch(err){ console.error(err); await showFluentAlert('No se pudo conectar al servidor.', 'Error', 'error'); }
    }

    function increaseQty(id){const it=CART.find(i=>i.id===id);if(it){it.qty+=1;updateCartUI();openCart();}}
    function decreaseQty(id){const it=CART.find(i=>i.id===id);if(!it) return; it.qty-=1; if(it.qty<=0) removeItem(id); updateCartUI(); openCart();}
    function removeItem(id){CART = CART.filter(i=>i.id!==id); updateCartUI(); openCart();}
    ...
    function checkout(){
      ...
      modal.innerHTML = `
        ...
        <form id="paymentForm" onsubmit="return processPayment(event)">
          ...
          <div style="margin-top:20px;text-align:right">
            ...
            <button type="submit" class="btn btn-primary">Pagar $${formatPrice(total)}</button>
          </div>
        </form>
      ...
      if(cardInput){
        cardInput.addEventListener('input', ()=>{
          ...
          if(cvvInput){
            if(type === 'AmEx'){
              cvvInput.maxLength = 4; cvvInput.placeholder = '4 dígitos';
            } else { cvvInput.maxLength = 3; cvvInput.placeholder = '123'; }
          }

          // auto-select card method and reveal fields
          const cardRadio = document.querySelector('input[name="payMethod"][value="card"]');
          if(cardRadio){ cardRadio.checked = true; cardFields.style.display = 'block'; }
        });
      }
      ...
      if(expiryInput){
        expiryInput.addEventListener('input', ()=>{
          ...
          if(v.length <= 2){ expiryInput.value = v; }
          else if(v.length <= 4){ expiryInput.value = v.slice(0,2) + '/' + v.slice(2); }
          else { expiryInput.value = v.slice(0,2) + '/' + v.slice(2,6); }
        });
      }
    }
    ...
    function previewProduct(id){
      ...
      modal.innerHTML = `
        <div class="modal-body">
          <div style='display:flex;gap:18px;flex-wrap:wrap'>
            <div style='flex:1;min-width:260px'>
              <img src='${p.img}' alt='${p.title}' style='width:100%;border-radius:10px;object-fit:cover;max-height:420px'>
            </div>
            <div style='flex:1;min-width:220px'>
              <h3 style="margin:6px 0">${p.title}</h3>
              <div style="margin-top:6px"><span class="tag">${CATEGORY_LABELS[p.category] || (p.category ? (p.category.charAt(0).toUpperCase()+p.category.slice(1)) : '')}</span></div>
              <p>${p.desc}</p>

              <div style='margin-top:8px'>
                <div class='muted'>Código: <strong>${p.code || '—'}</strong></div>
                <div class='muted'>Fabricante: <strong>${p.manufacturer || '—'}</strong></div>
                <div class='muted'>Modelo: <strong>${p.model || '—'}</strong></div>
                <div class='muted'>Garantía: <strong>${p.warranty || 'No aplica'}</strong></div>
                ${p.specs && p.specs.length ? `<div style="margin-top:8px"><div class='muted' style='margin-bottom:6px'>Especificaciones:</div><ul style="margin:0 0 0 18px;padding:0;list-style:disc">${p.specs.map(s=>`<li style="margin-bottom:6px">${s}</li>`).join('')}</ul></div>` : ''}
              </div>

              ${p.safety ? `<div class="safety-alert"><strong>ADVERTENCIA DE SEGURIDAD</strong><p style='margin:0'>${p.safety}</p></div>` : ''}

              <div style='margin-top:12px;display:flex;gap:16px;align-items:center'>
                <p class="price-modal" style='font-weight:700;color:var(--accent);margin:0'>$${formatPrice(p.price)}</p>
        ...
        <div class="modal-actions">
          ...
          <div style="margin-left:auto;display:flex;gap:8px;align-items:center">
            <button class="tag" title="Compartir en Facebook" onclick="shareFacebook(${p.id})" style="cursor:pointer;border:none;background:rgba(0,0,0,0.06);padding:8px;display:flex;align-items:center;justify-content:center">
            ...
            <button class="tag" title="Compartir en WhatsApp" onclick="shareWhatsApp(${p.id})" style="cursor:pointer;border:none;background:rgba(0,0,0,0.06);padding:8px;display:flex;align-items:center;justify-content:center">
            ...
            <button class="tag" title="Copiar enlace" onclick="copyProductLink(${p.id})" style="cursor:pointer;border:none;background:rgba(0,0,0,0.06);padding:8px;display:flex;align-items:center;justify-content:center">
    ...
    function applyFilters(){
      ...
      setTimeout(() => {
        ...
        try{ if(titleEl) titleEl.textContent = CATEGORY_LABELS[cat] || (cat.charAt(0).toUpperCase() + cat.slice(1)); }catch(e){}
        const max = parseFloat(document.getElementById('maxPrice').value) || Infinity;
        const sort = document.getElementById('sortBy').value;
        const q = document.getElementById('searchInput').value.trim().toLowerCase();
        let out = PRODUCTS.filter(p=> (cat==='all' || p.category===cat) && p.price<=max && (p.title.toLowerCase().includes(q) || p.desc.toLowerCase().includes(q) || p.category.toLowerCase().includes(q)) );
  ...
  renderProducts(out);
    ...
    function resetFilters(){
      ...
      try { localStorage.removeItem('selectedCategory'); } catch(e) {}
      applyFilters();
    }

  document.getElementById('searchInput').addEventListener('input',()=>{applyFilters()});
  // Persist selected category so a page refresh does not revert to "Todas"
  document.getElementById('categoryFilter').addEventListener('change',(e)=>{ try{ localStorage.setItem('selectedCategory', e.target.value); }catch(err){} applyFilters(); });
  ...
  (function(){
   ...
   function createCustomSelects(){
      document.querySelectorAll('select.select').forEach(select => {
        ...
        select.style.position = 'absolute'; select.style.opacity = 0; select.style.pointerEvents = 'none'; select.style.height = '0'; select.style.width = '0';

        // toggle button (shows current value)
        const toggle = document.createElement('button'); toggle.type = 'button'; toggle.className = 'cs-toggle';
        toggle.setAttribute('aria-haspopup','listbox'); toggle.setAttribute('aria-expanded','false');
        toggle.innerHTML = `<span class="cs-value">${select.options[select.selectedIndex]?.text || ''}</span><span class="cs-arrow"></span>`;
        wrapper.appendChild(toggle);

        // options panel
        const list = document.createElement('ul'); list.className = 'cs-options'; list.setAttribute('role','listbox');
        wrapper.appendChild(list);

        // populate
        Array.from(select.options).forEach((opt) => {
          const li = document.createElement('li'); li.className = 'cs-option'; li.setAttribute('role','option'); li.tabIndex = 0;
          li.textContent = opt.text; li.dataset.value = opt.value;
          if(opt.disabled){ li.classList.add('disabled'); li.setAttribute('aria-disabled','true'); li.tabIndex = -1 }
          if(opt.selected) li.classList.add('selected');
          li.addEventListener('click', (e)=>{ if(li.classList.contains('disabled')) return; select.value = li.dataset.value; select.dispatchEvent(new Event('change', {bubbles:true})); updateToggle(); close(); });
          list.appendChild(li);
        });

        function updateToggle(){ const s = select.options[select.selectedIndex]; toggle.querySelector('.cs-value').textContent = s ? s.text : ''; list.querySelectorAll('.cs-option').forEach(li => li.classList.toggle('selected', li.dataset.value == select.value)); }

        function open(){ list.style.display = 'block'; toggle.setAttribute('aria-expanded','true'); wrapper.classList.add('open'); }
        function close(){ list.style.display = 'none'; toggle.setAttribute('aria-expanded','false'); wrapper.classList.remove('open'); }

        toggle.addEventListener('click', (e) => { e.stopPropagation(); if(wrapper.classList.contains('open')) close(); else { open(); const f = list.querySelector('.cs-option:not(.disabled)'); if(f) f.focus(); } });

        // keyboard navigation
        toggle.addEventListener('keydown', (e) => {
          if(e.key === 'ArrowDown' || e.key === 'Enter' || e.key === ' '){ e.preventDefault(); open(); const f = list.querySelector('.cs-option:not(.disabled)'); if(f) f.focus(); }
        });
        list.addEventListener('keydown', (e) => {
          const active = document.activeElement;
          if(e.key === 'ArrowDown'){ e.preventDefault(); let next = active.nextElementSibling; while(next && next.classList.contains('disabled')) next = next.nextElementSibling; if(next) next.focus(); }
          else if(e.key === 'ArrowUp'){ e.preventDefault(); let prev = active.previousElementSibling; while(prev && prev.classList.contains('disabled')) prev = prev.previousElementSibling; if(prev) prev.focus(); }
    ...
    document.querySelectorAll('#filterToggle, #filterToggleHeader').forEach(btn => {
